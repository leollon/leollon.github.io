...
TCPIP开发者知道他们需要在能够与IP协作的网络层（Internet layer）上，通过提供额外的必要特性的另一层。
...
![a02769e3bc074551.svg](https://i.cthee.cyou/a02769e3bc074551.svg)

无连接协议的示意图：

![c7237981b1d042f0.svg](https://i.cthee.cyou/c7237981b1d042f0.svg)
...
![3c677c9d9e2c418b.svg](https://i.cthee.cyou/3c677c9d9e2c418b.svg)
...
![0a2e2f97a2b54fd3.png](https://i.cthee.cyou/0a2e2f97a2b54fd3.png)
![806adc354e5443a0.png](https://i.cthee.cyou/806adc354e5443a0.png)

已知的UDP端口：

![d10a759ae4254590.png](https://i.cthee.cyou/d10a759ae4254590.png)

## 多路复用/反多路复用

多路复用图例：

![418456e06e7f44e0.svg](https://i.cthee.cyou/418456e06e7f44e0.svg)

反多路复用图例：

![6482f7049b1d4d3b.svg](https://i.cthee.cyou/6482f7049b1d4d3b.svg)

多路复用/反多路复用使得TCPIP协议栈的更底层能够处理数据而不用管是哪个应用初始化的。所有和原始应用的关联都在Transport layer进行设置，并且数据以单独的，应用独立的管道传向或来自Internet Layer。
...
从[How TCPIP works](/How-TCP-IP-works)中，可以知道分层协议系统比如TCPIP通过交换在发送计算机给定层和接收
计算机相对应层之间信息来运转。换句话说，发送计算机上的网络接入层和读取数据帧的计算机的网络接入层进行通信。

回想起[What is TCPIP](/What-is-TCP-IP)中的端结点负责验证TCPIP上通信（端结点是那些实际上要进行通信的结点——
而不是转发消息的中间结点。）。

典型的网络互联的情况，数据由路由器从源子网传递到目的子网。

![a752a33da6784b02.svg](https://i.cthee.cyou/a752a33da6784b02.svg)

## TCP Data Format

TCP 数据格式图示

![d19083c8683f40c6.svg](https://i.cthee.cyou/d19083c8683f40c6.svg)
...
![a2b94c3679534b47.svg](https://i.cthee.cyou/a2b94c3679534b47.svg)
...
![85a28dee69f444e8.svg](https://i.cthee.cyou/85a28dee69f444e8.svg)
...
![2193b220d298492b.svg](https://i.cthee.cyou/2193b220d298492b.svg)
...
![8fa1d412400a4570.svg](https://i.cthee.cyou/8fa1d412400a4570.svg)
